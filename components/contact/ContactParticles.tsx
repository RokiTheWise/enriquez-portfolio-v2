...
/* Tuning — deliberately calmer than the hero */
const COUNT = 220;
const SPREAD = 5;
const SPEED = 0.15;
const BASE_SIZE = 120;
...
/* Blank 1×1 texture satisfies uMaskTex sampler without driving any glow */
...
function ParticleMesh() {
  ...
  const { geometry, uniforms } = useMemo(() => {
    ...
    const offsets = new Float32Array(COUNT * 2); // always zero — no CPU physics
